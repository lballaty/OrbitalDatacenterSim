/*
 * OrbitalDatacenterSim-reconcile.js
 * -----------------------------------------------------------------------------
 * Drift check between the app's in-page data-test-* tags and the canonical
 * manifest (OrbitalDatacenterSim-test-cases.json).
 *
...
(function (root) {
  ...
  function reconcile(manifest, opts) {
    ...
    declared.forEach(function (d, id) { if (!doc.getElementById(id)) report.manifest_only.push(id); });
    ...
    tagged.forEach(function (t, id) {
      ...
      if (d) {
        if (t.kind && d.kind && t.kind !== d.kind) {
